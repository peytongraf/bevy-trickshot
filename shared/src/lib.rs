...
pub use protocol::{
    AssetsReady, Bot, CreateLobby, EndGame, FallDeath, FallLanded, FellToDeath, GameChannel, GameMode, JoinLobby, KillCam,
...
pub const PROTOCOL_ID: u64 = 0x7213_c150_0000_0010;
