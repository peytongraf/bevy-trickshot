...
impl Default for KeyBindings {
    fn default() -> Self {
        ...
        Self {
            ...
            // Call of Duty (Modern Warfare) PC defaults: C crouch/slide, Ctrl prone/dive.
            crouch: Key(KeyCode::KeyC),
            prone: Key(KeyCode::ControlLeft),
...
pub const SLOTS: &[(&str, fn(&mut KeyBindings) -> &mut Binding)] = &[
    ...
    ("Jump", |b| &mut b.jump),
    ("Sprint", |b| &mut b.sprint),
    ("Crouch / Slide", |b| &mut b.crouch),
    ("Prone / Dolphin Dive", |b| &mut b.prone),
    ("Fire", |b| &mut b.fire),
